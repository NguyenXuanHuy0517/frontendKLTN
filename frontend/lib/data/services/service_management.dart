...
class ServiceManagement {
  ...
  Future<List<ServiceModel>> getServices(int areaId) async {
    final res =
    await _dio.get('/api/host/areas/$areaId/services');
  ...
  Future<ServiceModel> createService(
      int areaId, Map<String, dynamic> data) async {
    final res =
    await _dio.post('/api/host/areas/$areaId/services', data: data);
  ...
  Future<ServiceModel> updateService(
    ...
    final res = await _dio
        .put('${ApiConstants.services}/$serviceId', data: data);
    return ServiceModel.fromJson(res.data['data']);
  }
