...
import '../data/services/tenant_notification_service.dart';
import 'paged_list_state.dart';

class TenantNotificationListProvider extends ChangeNotifier {
  static const _pageSize = 20;

  final _service = TenantNotificationService();
  ...
  Future<void> markAsRead(int notificationId) async {
    final userId = _userId;
    if (userId == null || _readingIds.contains(notificationId)) return;
